...
{
    // This class is responsible for ensuring that the native library is loaded correctly on all platforms.
    // Cf. https://learn.microsoft.com/en-us/dotnet/standard/native-interop/native-library-loading
